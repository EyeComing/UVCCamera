...
public class MediaMuxerWrapper {
    ...
    private static final String DIR_NAME = "EyeComing";
    ...
    public MediaMuxerWrapper(String path, String ext) throws IOException {
        ...
        try {
            mOutputPath = getCaptureFileByPath(path, ext).toString();
        } catch (final NullPointerException e) {
            throw new RuntimeException("This app has no permission of writing external storage");
        }
        mMediaMuxer = new MediaMuxer(mOutputPath, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
...
//**********************************************************************
    ...
    public static final File getCaptureFileByPath(final String path, final String ext) {
