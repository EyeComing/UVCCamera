...
//================================================================================
	...
	public static String getProfileLevelString(final String mimeType,
		...
		} else if ("video/h263".equalsIgnoreCase(mimeType)) {
			switch (profileLevel.profile) {
		...
		} else if ("video/mpeg4".equalsIgnoreCase(mimeType)) {
			switch (profileLevel.profile) {
		...
		} else if ("ausio/aac".equalsIgnoreCase(mimeType)) {
		...
		} else if ("video/vp8".equalsIgnoreCase(mimeType)) {
			switch (profileLevel.profile) {
